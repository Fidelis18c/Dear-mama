      ...
      {IsOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white w-[20rem] ml-[3rem]  mt-[10rem] rounded-3xl md:mt-0 md:shadow-2xl md:max-w-2xl md:ml-0 md:w-full md:relative"

          >
            {/* Close button */}
            <button
              onClick={() => setIsOpen(false)}
              className="absolute right-[4rem] top-[11rem] text-2xl md:right-6  md:top-4 md:text-3xl font-bold text-gray-400 hover:text-gray-800"
              aria-label="Close"
              type="button"
            >
              &times;
