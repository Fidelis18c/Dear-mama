            ...
            <div>
             ...
             <div>
               <h2 className='pt-1 text-xl md:text-[17px] text-black font-bold text-center font-montserrat md:text-wrap md:pt-2'>Holistic Community <br /> Well-being.</h2>
                <p className='max-w-xs pt-2 text-black md:text-balance font-light text-left text-sm md:pt-2 pl-4 md:ml-7 pr-5 '>Our volunteers provide 100% support to patients in hospitals, 
        ...
        <div className='flex flex-col pb-4 items-center justify-center rounded-lg ml-4 mr-3 mb-5  bg-gray-200 md:max-w-xs md:bg-gray-100 md:rounded-xl md:overflow-hidden md:shadow-md md:mr-[4rem] md:pb-[2rem]'>
          <div>
           ...
           <div>
             ...
             <p className='max-w-xs pt-2 text-black text-left md:text-balance font-light md:ml-3 text-sm md:pt-3 pl-6 pr-2'>We mobilize swiftly to address unexpected community emergencies and natural disasters,
